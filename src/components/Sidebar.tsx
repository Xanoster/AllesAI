...
import { MessageSquarePlus, Trash2, Search, Sparkles } from "lucide-react";
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-[var(--border)] bg-[var(--bg-soft)] md:flex">
      {/* Brand + theme */}
      <div className="flex items-center justify-between border-b border-[var(--border)] px-3 py-2.5">
        <div className="flex items-center gap-1.5">
          <div className="rounded-lg bg-gradient-to-br from-blue-500 to-purple-500 p-1.5 text-white">
            <Sparkles size={13} />
          </div>
          <span className="text-sm font-semibold tracking-tight">Alles AI</span>
        </div>
        <ThemeToggle />
      </div>
